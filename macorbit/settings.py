"""
Django settings for macorbit project.
...
SECRET_KEY = 'django-insecure-clpgh5u%1r2z)%v3pr(d^&s8by*$h_5(w@_9bq6^x+4f1(-bz9'
...
WSGI_APPLICATION = 'macorbit.wsgi.application'
